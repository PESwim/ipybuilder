...
#
# Copyright 2018 - Howard Dunn - PE LLC. Apache 2.0 v.2 licensed. 
# Modified/derivative work from original.#
#
...
# hdunn 4/6/2018 debug fix: global i not referenced err in ipy
# commented out ----------------------------------------
#_ignorecase_fixes = {i: tuple(j for j in t if i != j)
#                     for t in _equivalences for i in t}
# ------------------------------------------------------
# hdunn 4/6/2018 debug fix: add global func scope closure 
def _igncase(_equivalences):
    #    dic = {}
    ...
    ignorecase = {i: tuple(j for j in t if i != j)
                    for t in _equivalences for i in t}
    return ignorecase

_ignorecase_fixes = _igncase(_equivalences)
# --------------------------------------------------------
